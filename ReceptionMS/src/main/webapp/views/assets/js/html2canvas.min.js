...
!function(A, e) {
	...
	return function(A) {
			...
			s = function() {
				function A(e) {
					!function(A, e) {
						if (!(A instanceof e))
							throw new TypeError("Cannot call a class as a function")
					}(this, A), this.type = "%" === e.substr(e.length - 1) ? a.PERCENTAGE : a.PX;var t = parseFloat(e);
		...
		var s = e.Bounds = function() {
			...
			o = (e.parseBounds = function(A, e, t) {
				...
				case 0:
					...
					return o(A.bottomRightOuter, A.bottomRightInner, A.bottomLeftOuter, A.bottomLeftInner);case 3:
				default:
			...
			c = function(A, e, t, r, a) {
				...
				case i.TOP_LEFT:
					...
					return new B.default(new n.default(l, e), new n.default(l, e + c), new n.default(A + o, u), new n.default(A, u));case i.BOTTOM_LEFT:
				default:
		...
		var L = function(A, e) {
			...
			case "IMG":
				var r = A;
				return e.loadImage(r.currentSrc || r.src);case "CANVAS":
				var n = A;
				return e.loadCanvas(n);case "IFRAME":
		...
		var c = e.BACKGROUND_REPEAT = {
			...
			g = (e.calculateBackgroungPaintingArea = function(A, e) {
				switch (e) {
				case u.BORDER_BOX:
					return (0, s.calculateBorderBoxPath)(A);case u.PADDING_BOX:
				default:
				...
				case Q.BORDER_BOX:
					...
					return new s.Bounds(n.left + B, n.top + i, n.width - B - a, n.height - i - c);case Q.PADDING_BOX:
				default:
					return n
				}
				...
				return t.map(function(A, e) {
					...
					return {
						...
						repeat : function(A) {
							switch (A.trim()) {
							case "no-repeat":
								return c.NO_REPEAT;case "repeat-x":
							case "repeat no-repeat":
								return c.REPEAT_X;case "repeat-y":
			...
			E = function(A) {
				...
				case "bottom":
				case "right":
					return new n.default("100%");case "left":
				case "top":
		...
		var r = t(5),
			...
			a = e.parseListStyleType = function(A) {
				...
				case "disc":
					...
					return B.DISCLOSURE_CLOSED;case "none":
				default:
					return B.NONE
				}
			},
				...
				get SUPPORT_SVG_DRAWING() {
					var A = function(A) {
						var e = new Image,
							...
							r = t.getContext("2d");
						e.src = "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg'></svg>";try {
		...
		var i = [ "OL", "UL", "MENU" ],
			c = (e.getListOwner = function(A) {
				...
				if (s) {
					...
					case a.LIST_STYLE_POSITION.OUTSIDE:
						...
						break;case a.LIST_STYLE_POSITION.INSIDE:
			...
			F = e.createCounterText = function(A, e, t) {
				...
				case a.LIST_STYLE_TYPE.DISC:
					...
					var s = g(A, 48, 57, !0, r);
					return s.length < 4 ? "0" + s : s;case a.LIST_STYLE_TYPE.CJK_DECIMAL:
					...
					return g(A, 1632, 1641, !0, r);case a.LIST_STYLE_TYPE.ARMENIAN:
				case a.LIST_STYLE_TYPE.UPPER_ARMENIAN:
					...
					return g(A, 2534, 2543, !0, r);case a.LIST_STYLE_TYPE.CAMBODIAN:
				case a.LIST_STYLE_TYPE.KHMER:
					...
					return C(A, "甲乙丙丁戊己庚辛壬癸", n);case a.LIST_STYLE_TYPE.CJK_IDEOGRAPHIC:
				case a.LIST_STYLE_TYPE.TRAD_CHINESE_INFORMAL:
					...
					return g(A, 3872, 3881, !0, r);case a.LIST_STYLE_TYPE.DECIMAL:
				default:
								...
								if (a.ctx.fillStyle = e.toString(), n && A.text.trim().length ? n.slice(0).reverse().forEach(function(e) {
									...
									r.textDecorationLine.forEach(function(e) {
										...
										case B.TEXT_DECORATION_LINE.UNDERLINE:
											...
											break;case B.TEXT_DECORATION_LINE.OVERLINE:
											a.rectangle(A.bounds.left, Math.round(A.bounds.top), A.bounds.width, 1, s);
											break;case B.TEXT_DECORATION_LINE.LINE_THROUGH:
		...
		e.parseOverflowWrap = function(A) {
			switch (A) {
			case "break-word":
				return r.BREAK_WORD;case "normal":
			default:
				return r.NORMAL
			}
		}
		...
		var c = [ "SCRIPT", "HEAD", "TITLE", "OBJECT", "BR", "OPTION" ],
			l = function A(e, t, i, l, w) {
				for (var U, g = e.firstChild; g; g = U) {
					U = g.nextSibling;var C = g.ownerDocument.defaultView;
		...
		e.parseVisibility = function(A) {
			...
			case "hidden":
				...
				return r.COLLAPSE;case "visible":
			default:
				return r.VISIBLE
			}
		}
					...
					value : function(A, e) {
						...
						if (o) switch (o.type) {
							case s.GRADIENT_TYPE.LINEAR_GRADIENT:
								...
								break;case s.GRADIENT_TYPE.RADIAL_GRADIENT:
		...
		var l = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
			...
			I = function(A, e) {
				...
				case "bottom":
				case "to top":
					return p(0, e);case "left":
				case "to right":
					return p(Math.PI / 2, e);case "right":
				case "to left":
					return p(3 * Math.PI / 2, e);case "top right":
				case "right top":
				case "to bottom left":
				case "to left bottom":
					return p(Math.PI + N(e), e);case "top left":
				case "left top":
				case "to bottom right":
				case "to right bottom":
					return p(Math.PI - N(e), e);case "bottom left":
				case "left bottom":
				case "to top right":
				case "to right top":
					return p(N(e), e);case "bottom right":
				case "right bottom":
				case "to top left":
				case "to left top":
					return p(2 * Math.PI - N(e), e);case "top":
				case "to bottom":
				default:
					return p(Math.PI, e)
				}
					...
					if ((0, o.copyCSSStyles)(t, B), r)
						for (var a = r.length, s = 0; s < a; s++) {
							...
							case l.PSEUDO_CONTENT_ITEM_TYPE.IMAGE:
								...
								break;case l.PSEUDO_CONTENT_ITEM_TYPE.TEXT:
					...
					value : function(A) {
						...
						return this.cache[A] = new Promise(function(t, r) {
								...
								if (n.onreadystatechange = function() {
										if (4 === n.readyState)
											if (200 !== n.status) r("Failed to fetch image " + A.substring(0, 256) + " with status code " + n.status);else {
